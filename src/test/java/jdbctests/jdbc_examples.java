...
public class jdbc_examples {
    ...
    public void CountandNavigate() throws SQLException {
        ...
        resultSet.last();
        int rowCount = resultSet.getRow();// total row number
        System.out.println("rowCount = " + rowCount);
     // for get total row name , we need to move before the first row to get full list since we are at the last row right now
